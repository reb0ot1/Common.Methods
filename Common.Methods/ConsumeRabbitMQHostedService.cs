...
{
    public class ConsumeRabbitMQHostedService<T> : BackgroundService 
        where T : class 
    {
        ...
        {
            this._logger = loggerFactory.CreateLogger<ConsumeRabbitMQHostedService<T>>();
